using ApiFournisseurIdentite.Data;
using ApiFournisseurIdentite.Models;
...
builder.Services.AddIdentityServer(options =>
    ...
    .AddInMemoryClients(new Client[] {
         new Client
         {
            ...
            AllowOfflineAccess = true  //mettre ca en commentaire dans backend // options.Scope.Add("offline_access");
         }
    })
